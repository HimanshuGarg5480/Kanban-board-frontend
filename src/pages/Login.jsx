    ...
    <div className="h-screen relative">
      ...
      <div className="h-[100%] bg-[#B4B4B8] w-full flex flex-col sm:flex-row justify-evenly">
        <div className=" w-[100%] sm:w-[60%] sm:h-[100%] flex flex-col justify-center">
          <form className="w-[90%] mx-auto mt-[22%] sm:mt-[5%] border-2 border-[#605e5e] p-3 md:p-14 py-7 sm:py-11 md:p-13 flex flex-col justify-start text-[#38362c] text-lg bg-[#a0a0a3] rounded-lg">
            <label className="w-full" htmlFor="email">
              Email (required)
            </label>
            <input
              className="rounded-lg mb-8 h-10 p-4"
              id="email"
              type="text"
              placeholder="email"
            />
            ...
            <input
              className="rounded-lg mb-10 h-10 p-4"
              id="password"
              type="password"
        ...
        <div className="w-[100%] sm:w-[40%]  flex sm:flex-col sm:items-center justify-center">
          <img className="w-[350px] sm:w-[400px] sm:h-[200px] md:w-[600px] md:h-[250px]" width="400" src={kanban} alt="" />
        </div>
      </div>
    </div>
  );
